...
\TLV
   ...
   $imm[31:0] = $is_i_instr ? {{21{$instr[31]}}, $instr[30:20]} :
                ...
                32'b0;
   // Checking which fields are used in what type of instructions
   ...
   // Reading the instructions --> DECODE PROCESS
   $dec_bits[10:0] = {$instr[30],$funct3,$opcode};
   //--Basic test program instructions--------
   ...
   // 5-bits maximum --> therefore can shift at max 31 positions.
   //------------------------------------------------------------
